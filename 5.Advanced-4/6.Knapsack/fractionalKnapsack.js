...
// Find out the maximum total value that we can fit in the knapsack. If the maximum total value 
// is ans, then return ⌊ans × 100⌋ , i.e., floor of (ans × 100).
...
// Output Format
// Return a single integer denoting the maximum total value of A such that sum of the weights 
